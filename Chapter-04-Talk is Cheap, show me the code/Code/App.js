...
const RestaurautCard = ({
  ...
  return (
    <div className="card">
      <img src={imgCdn + cloudinaryImageId}></img>
  ...
  return (
    <>
      <div className="main">
        ...
        {/* One way of displaying multiple cards is to render RestaurautCard multiple times
      <RestaurautCard/>
      <RestaurautCard/>
      <RestaurautCard/>
      <RestaurautCard/> */}

        {/* Other way is to use map function to map data from restaurantList */}
        <div className="main-content">
          {restaurantList.map((item) => {
            return <RestaurautCard {...item.data} key={item.data.id} />;
          })}
        </div>
      </div>
    </>
